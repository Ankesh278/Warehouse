...
class _AddWareHouseState extends State<AddWareHouse> {
  ...
  final List<String> _warehouseTypes = [
    'Cons 1',
    'cons 2',
    'cons 3',
  ];
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        try {
          ...
          if (response.statusCode == 200 && responseData['status'] == 201) {
                                ...
                                children:[
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButtonFormField<String>(
                                      ...
                                      items: _warehouseTypes.map((String type) {
                                  ...
                                  Row(
                                    children: [
                                      const Text("Warehouse Name",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w500),),
                                      Padding(
                                        padding: const EdgeInsets.only(right: 2.0),
